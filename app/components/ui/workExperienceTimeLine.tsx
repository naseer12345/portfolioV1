  ...
  return (
    ...
    <ol className="relative border-s border-gray-200 dark:border-gray-700">                  
      <li className="mb-10 ms-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Software Developer Intern - Comma, now Weaver.io</h3>
      ...
      <li className="mb-10 ms-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Web Developer (Contract)- Family Business </h3>
      ...
      <li className="ms-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">.NET Developer - <i><a href="https://www.focus4people.com/">Focus4People</a></i>  </h3>
